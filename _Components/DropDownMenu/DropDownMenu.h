...
@interface DropDownMenuIndexPath : NSObject
 ...
 */
- (NSString *)menu:(DropDownMenu *)menu titleForRowAtIndexPath:(DropDownMenuIndexPath *)indexPath;
...
- (NSString *)menu:(DropDownMenu *)menu imageNameForRowAtIndexPath:(DropDownMenuIndexPath *)indexPath;

// 新增 detailText ,right text
- (NSString *)menu:(DropDownMenu *)menu detailTextForRowAtIndexPath:(DropDownMenuIndexPath *)indexPath;
 ...
 *  如果都没有可以不实现该协议
 */
- (NSString *)menu:(DropDownMenu *)menu titleForItemsInRowAtIndexPath:(DropDownMenuIndexPath *)indexPath;

// 新增 当有column列 row 行 item项 image
- (NSString *)menu:(DropDownMenu *)menu imageNameForItemsInRowAtIndexPath:(DropDownMenuIndexPath *)indexPath;
// 新增
- (NSString *)menu:(DropDownMenu *)menu detailTextForItemsInRowAtIndexPath:(DropDownMenuIndexPath *)indexPath;
 ...
 */
- (void)menu:(DropDownMenu *)menu didSelectRowAtIndexPath:(DropDownMenuIndexPath *)indexPath;

/** 新增
 *  return nil if you don't want to user select specified indexpath
 *  optional
 */
- (NSIndexPath *)menu:(DropDownMenu *)menu willSelectRowAtIndexPath:(DropDownMenuIndexPath *)indexPath;
...
//add by xiyang
@property (nonatomic, copy) void(^finishedBlock)(DropDownMenuIndexPath *indexPath);//回收回调
...
- (void)selectIndexPath:(DropDownMenuIndexPath *)indexPath; // 默认trigger delegate

- (void)selectIndexPath:(DropDownMenuIndexPath *)indexPath triggerDelegate:(BOOL)trigger; // 调用代理
