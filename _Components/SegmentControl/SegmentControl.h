...
//
//  Usage: https://github.com/HeshamMegid/HMSegmentedControl
...
typedef NS_ENUM(NSInteger, HMSegmentedControlType) {
    HMSegmentedControlTypeText,                 // 文字样式
    HMSegmentedControlTypeImages,               // 图片样式
	HMSegmentedControlTypeTextImages,           // 文字＋图片样式
};
...
@property (nonatomic, strong) UIColor *titleButtonStyleBorderColor;
@property (nonatomic, strong) UIColor *titleButtonStyleBackgroundColor;
@property (nonatomic, assign) CGFloat titleButtonStyleCornerRadius;
