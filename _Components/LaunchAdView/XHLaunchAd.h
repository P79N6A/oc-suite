 ...
 *  倒计时类型
 */
typedef NS_ENUM(NSInteger, LaunchAdSkipType) {
    LaunchAdSkipTypeNone      = 1,//无
    LaunchAdSkipTypeTime      = 2,//倒计时
    LaunchAdSkipTypeText      = 3,//跳过
    LaunchAdSkipTypeTimeText  = 4,//倒计时+跳过
 ...
 */
- (void)setImageUrl:(NSString *)imageUrl duration:(NSInteger)duration skipType:(LaunchAdSkipType)skipType options:(XHWebImageOptions)options completed:(XHWebImageCompletionBlock)completedBlock click:(clickBlock)click;
