...
UIImage *__imageFromColor(UIColor *color, CGSize size){
...
- (instancetype)initWithFrame:(CGRect)frame title:(NSString *)title message:(NSString *)message {
    if(self=[super initWithFrame:frame]) {
        ...
        [closeButton setBackgroundImage:__imageFromColor(ButtonBgColor, CGSizeMake(5, 5)) forState:UIControlStateNormal];
