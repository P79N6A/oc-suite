...
void __CreateRoundedRectPath(CGContextRef context, CGRect rect, CGFloat arcRadius) {
...
@interface AlertModalBackgroundView () {
    UIColor *fillColor;
    UIColor *strokeColor;
    CGRect  _cropRect;
...
@implementation AlertModalBackgroundView
...
- (void)drawRect:(CGRect)rect {
    ...
    if(!CGSizeEqualToSize(_cropSize, CGSizeZero)){
        ...
        __CreateRoundedRectPath(ctx,_cropRect, kDefaultCornerRadius);
