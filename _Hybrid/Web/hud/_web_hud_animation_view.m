...
@interface _WebHUDAnimationView ()
...
@property (nonatomic) _WebHUDAnimationType type;

@end


@implementation _WebHUDAnimationView
...
- (void)showAnimationAtView:(UIView *)view animationType:(_WebHUDAnimationType)animationType {
    ...
    switch (animationType) {
        case _WebHUDAnimationTypeCircle:
            self.count = 10;
            [self configCircle];
            break;
        case _WebHUDAnimationTypeCircleJoin:
            self.count = 100;
            [self configCircle];
            break;
        case _WebHUDAnimationTypeDot:
            self.count = 3;
            [self configDot];
            break;
        default:
