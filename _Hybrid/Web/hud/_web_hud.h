...
typedef enum : NSUInteger {
    _WebHUDLoadingTypeCircleJoin       = 1, // 默认
    _WebHUDLoadingTypeGifImage         = 4,
    _WebHUDLoadingTypeFailure          = 5,
} _WebHUDLoadingType;

@interface _WebHUD : UIView

// When JHUDLoadingTypeFailure, there will be a "refresh" button, and the method.
@property (nonatomic, copy)  void(^ reloadButtonClickedBlock)();
