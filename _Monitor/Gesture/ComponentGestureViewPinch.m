...
@implementation ComponentGestureViewPinch
{
	BOOL						_animating;
...
- (void)setGesture:(UIGestureRecognizer *)gesture
{
	...
	_finger1.image = [[ComponentGesture instance].bundle imageForResource:@"gesture-pinch.png"];
	_finger2.image = [[ComponentGesture instance].bundle imageForResource:@"gesture-spread.png"];
}
