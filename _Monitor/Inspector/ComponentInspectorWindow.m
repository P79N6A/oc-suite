...
@interface ComponentImageView : UIImageView
...
@implementation ComponentImageView
...
@implementation ComponentInspectorWindow
{
	CGFloat						_rotateX;
    CGFloat						_rotateY;
    CGFloat						_distance;
...
- (CGFloat)buildSublayersForView:(UIView *)view origin:(CGPoint)origin depth:(CGFloat)depth
{
	...
	{
		ComponentImageView * capturedView = [[ComponentImageView alloc] init];
...
//	
//	for ( ComponentImageView * subview in subviewsCopy )
//	{
//		if ( [subview isKindOfClass:[ComponentImageView class]] )
//		{
...
- (void)didClicked:(UITapGestureRecognizer *)tapGesture
{
	...
	{
		if ( tapGesture.view && [tapGesture.view isKindOfClass:[ComponentImageView class]] )
		{
			ComponentImageView * view = (ComponentImageView *)tapGesture.view;
		}
	}
}
