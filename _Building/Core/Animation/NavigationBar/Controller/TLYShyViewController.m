...
// Use when fadeBehaviour == TLYShyNavBarFadeOutFixedNavbar
@property (nonatomic, assign) CGPoint simulateCenter;
...
//    self.simulateCenter = self.view.center;
...
//    else {
//        // 如果固定位置
//        if (self.fadeBehavior == TLYShyNavBarFadeOutFixedNavbar) {
//            CGFloat newYOffset = self.simulateCenter.y + deltaY;
//            
//            CGPoint expandedCenter = CGPointMake(CGRectGetMidX(self.view.bounds),
//                                         CGRectGetMidY(self.view.bounds));
//            
//            center.y += [self.parent maxYRelativeToView:self.view.superview];
//            
