...
//
// 传输加密的流程说明：
// 1. 服务器和客户端之间，传输非对称加密的公钥
// 2. 客户端用公钥加密 对称加密的私钥(随机生成）, 传给服务器
// 3. 客户端用 对称加密的私钥加密明文，传给服务器
// 4. 服务器用 非对称加密的私钥解密出 对称加密的私钥
// 5. 服务器用 对称加密的私钥 解密出明文
...
@interface _TransitEncryptor : NSObject
 ...
 */
- (_TransitEncryptor *)initWithX509PublicKeyData:(NSData *)base64KeyData;
 ...
 * @return new ObjectiveTLS instance
 */
- (_TransitEncryptor *)initWithX509PublicKey:(NSString *)publicKeyPath;
