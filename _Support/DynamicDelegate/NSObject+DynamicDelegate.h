...
/** The _DynamicDelegate category to NSObject provides the primary interface
 by which dynamic delegates are generated for a given object. */
@interface NSObject (DynamicDelegate)

/** Creates or gets a dynamic data source for the reciever.

 _DynamicDelegate assumes a protocol name `FooBarDataSource`
 ...
 of _DynamicDelegate, its implementation of any method
 ...
 @see <_DynamicDelegate>blockImplementationForMethod:
...
/** Creates or gets a dynamic delegate for the reciever.
 ...
 _DynamicDelegate assumes a protocol name `FooBarDelegate`
 for instances of class `FooBar`. The object is given a strong
 attachment to the reciever, and is automatically deallocated
 when the reciever is released.
...
/** Creates or gets a dynamic protocol implementation for
 ...
 If the user implements a subclass of _DynamicDelegate prepended
