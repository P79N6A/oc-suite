...
static NSArray *__classMethodNames(Class c) {
...
__unused static void __printDescription(NSString *name, id obj) {
    NSString *str = [NSString stringWithFormat:
                     ...
                     [__classMethodNames(object_getClass(obj)) componentsJoinedByString:@", "]];
    printf("%s\n", [str UTF8String]);
}
...
- (Class)makeKvoClassWithOriginalClassName:(NSString *)originalClazzName {
    NSString *kvoClazzName = [KVOClassPrefix stringByAppendingString:originalClazzName];
...
- (void)observe:(NSObject *)observable
    ...
    if (![observableClazzName hasPrefix:KVOClassPrefix]) {
        observableClazz = [observable makeKvoClassWithOriginalClassName:observableClazzName];
