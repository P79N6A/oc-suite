...
- (void)renderRegionWithPoints:(CGPoint *)points
                    pointCount:(NSUInteger)pointCount
                     fillColor:(UIColor *)fillColor
               strokeLineWidth:(CGFloat)strokeLineWidth
              usingTriangleFan:(BOOL)usingTriangleFan __attribute__ ((deprecated("use - (void)renderRegionWithPoints:(CGPoint *)points pointCount:(NSUInteger)pointCount fillColor:(UIColor *)fillColor usingTriangleFan:(BOOL)usingTriangleFan; instead")));
