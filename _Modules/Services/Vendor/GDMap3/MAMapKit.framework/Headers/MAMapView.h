...
/*!
 @brief 在当前缩放级别下, 基于地图中心点, 1 screen point 对应的距离(单位是米).(已废弃)
 @return 对应的距离(单位是米)
 */
- (double)metersPerPointForCurrentZoomLevel __attribute((deprecated("use - @property (nonatomic, readonly) double metersPerPointForCurrentZoom instead")));
 ...
 */
- (MAOverlayView *)viewForOverlay:(id <MAOverlay>)overlay __attribute__ ((deprecated("use - (MAOverlayRenderer *)mapView:(MAMapView *)mapView rendererForOverlay:(id <MAOverlay>)overlay instead")));
...
/*!
 ...
 @param dataSize 数据大小
 */
- (void)mapViewDidFinishLoadingMap:(MAMapView *)mapView dataSize:(NSInteger)dataSize __attribute__ ((deprecated("use - (void)mapViewDidFinishLoadingMap:(MAMapView *)mapView instead")));
 ...
 */
- (void)mapView:(MAMapView *)mapView didAddOverlayViews:(NSArray *)overlayViews __attribute__ ((deprecated("use - (void)mapView:(MAMapView *)mapView didAddOverlayRenderers:(NSArray *)overlayRenderers instead")));
