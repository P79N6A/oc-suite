...
static NSString* const RMStoreCoderConsumedKey = @"consumed";
static NSString* const RMStoreCoderProductIdentifierKey = @"productIdentifier";
static NSString* const RMStoreCoderTransactionDateKey = @"transactionDate";
static NSString* const RMStoreCoderTransactionIdentifierKey = @"transactionIdentifier";
#if __IPHONE_OS_VERSION_MIN_REQUIRED < 70000
static NSString* const RMStoreCoderTransactionReceiptKey = @"transactionReceipt";
#endif

@implementation ALSRMStoreTransaction
