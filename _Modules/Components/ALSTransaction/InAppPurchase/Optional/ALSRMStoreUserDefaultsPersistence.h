 ...
 */
@interface ALSRMStoreUserDefaultsPersistence : NSObject<ALSRMStoreTransactionPersistor>
 ...
 */
@interface ALSRMStoreUserDefaultsPersistence(Obfuscation)
