...
NSString * const ALSKeyChainStoreErrorDomain = @"com.kishikawakatsumi.uickeychainstore";
static NSString *_defaultService;

@interface ALSKeyChainStore ()

@end

@implementation ALSKeyChainStore
...
+ (ALSKeyChainStore *)keyChainStoreWithService:(NSString *)service
{
    return [[self alloc] initWithService:service accessGroup:nil];
}

+ (ALSKeyChainStore *)keyChainStoreWithService:(NSString *)service accessGroup:(NSString *)accessGroup
{
...
{
    return [[self alloc] initWithServer:server protocolType:protocolType authenticationType:ALSKeyChainStoreAuthenticationTypeDefault];
}
...
- (instancetype)initWithService:(NSString *)service accessGroup:(NSString *)accessGroup
{
    self = [super init];
    if (self) {
        _itemClass = ALSKeyChainStoreItemClassGenericPassword;
...
{
    return [self initWithServer:server protocolType:protocolType authenticationType:ALSKeyChainStoreAuthenticationTypeDefault];
}
...
- (instancetype)initWithServer:(NSURL *)server protocolType:(ALSKeyChainStoreProtocolType)protocolType authenticationType:(UICKeyChainStoreAuthenticationType)authenticationType
{
    self = [super init];
    if (self) {
        _itemClass = ALSKeyChainStoreItemClassInternetPassword;
...
- (void)commonInit
{
    _accessibility = ALSKeyChainStoreAccessibilityAfterFirstUnlock;
...
+ (NSString *)stringForKey:(NSString *)key service:(NSString *)service accessGroup:(NSString *)accessGroup error:(NSError *__autoreleasing *)error
{
    ...
    ALSKeyChainStore *keychain = [ALSKeyChainStore keyChainStoreWithService:service accessGroup:accessGroup];
...
+ (NSArray UIC_KEY_TYPE *)allKeysWithItemClass:(ALSKeyChainStoreItemClass)itemClass
{
    CFTypeRef itemClassObject = kSecClassGenericPassword;
    if (itemClass == ALSKeyChainStoreItemClassGenericPassword) {
        itemClassObject = kSecClassGenericPassword;
    } else if (itemClass == ALSKeyChainStoreItemClassInternetPassword) {
...
+ (NSArray *)allItemsWithItemClass:(ALSKeyChainStoreItemClass)itemClass
{
    CFTypeRef itemClassObject = kSecClassGenericPassword;
    if (itemClass == ALSKeyChainStoreItemClassGenericPassword) {
        itemClassObject = kSecClassGenericPassword;
...
- (NSMutableDictionary *)attributesWithKey:(NSString *)key value:(NSData *)value error:(NSError *__autoreleasing *)error
{
    ...
    if (_authenticationPolicy && accessibilityObject) {
        ...
        if (floor(NSFoundationVersionNumber) <= floor(iOS_7_1_or_10_9_2) && _accessibility == ALSKeyChainStoreAccessibilityWhenPasscodeSetThisDeviceOnly) {
#if TARGET_OS_IOS
...
{
    switch (_itemClass) {
        case ALSKeyChainStoreItemClassGenericPassword:
            return kSecClassGenericPassword;
        case ALSKeyChainStoreItemClassInternetPassword:
...
- (CFTypeRef)protocolTypeObject
{
    switch (_protocolType) {
        case ALSKeyChainStoreProtocolTypeFTP:
            return kSecAttrProtocolFTP;
        case ALSKeyChainStoreProtocolTypeFTPAccount:
            return kSecAttrProtocolFTPAccount;
        case ALSKeyChainStoreProtocolTypeHTTP:
            return kSecAttrProtocolHTTP;
        case ALSKeyChainStoreProtocolTypeIRC:
            return kSecAttrProtocolIRC;
        case ALSKeyChainStoreProtocolTypeNNTP:
            return kSecAttrProtocolNNTP;
        case ALSKeyChainStoreProtocolTypePOP3:
            return kSecAttrProtocolPOP3;
        case ALSKeyChainStoreProtocolTypeSMTP:
            return kSecAttrProtocolSMTP;
        case ALSKeyChainStoreProtocolTypeSOCKS:
            return kSecAttrProtocolSOCKS;
        case ALSKeyChainStoreProtocolTypeIMAP:
            return kSecAttrProtocolIMAP;
        case ALSKeyChainStoreProtocolTypeLDAP:
            return kSecAttrProtocolLDAP;
        case ALSKeyChainStoreProtocolTypeAppleTalk:
            return kSecAttrProtocolAppleTalk;
        case ALSKeyChainStoreProtocolTypeAFP:
            return kSecAttrProtocolAFP;
        case ALSKeyChainStoreProtocolTypeTelnet:
            return kSecAttrProtocolTelnet;
        case ALSKeyChainStoreProtocolTypeSSH:
            return kSecAttrProtocolSSH;
        case ALSKeyChainStoreProtocolTypeFTPS:
            return kSecAttrProtocolFTPS;
        case ALSKeyChainStoreProtocolTypeHTTPS:
            return kSecAttrProtocolHTTPS;
        case ALSKeyChainStoreProtocolTypeHTTPProxy:
            return kSecAttrProtocolHTTPProxy;
        case ALSKeyChainStoreProtocolTypeHTTPSProxy:
            return kSecAttrProtocolHTTPSProxy;
        case ALSKeyChainStoreProtocolTypeFTPProxy:
            return kSecAttrProtocolFTPProxy;
        case ALSKeyChainStoreProtocolTypeSMB:
            return kSecAttrProtocolSMB;
        case ALSKeyChainStoreProtocolTypeRTSP:
            return kSecAttrProtocolRTSP;
        case ALSKeyChainStoreProtocolTypeRTSPProxy:
            return kSecAttrProtocolRTSPProxy;
        case ALSKeyChainStoreProtocolTypeDAAP:
            return kSecAttrProtocolDAAP;
        case ALSKeyChainStoreProtocolTypeEPPC:
            return kSecAttrProtocolEPPC;
        case ALSKeyChainStoreProtocolTypeNNTPS:
            return kSecAttrProtocolNNTPS;
        case ALSKeyChainStoreProtocolTypeLDAPS:
            return kSecAttrProtocolLDAPS;
        case ALSKeyChainStoreProtocolTypeTelnetS:
            return kSecAttrProtocolTelnetS;
        case ALSKeyChainStoreProtocolTypeIRCS:
            return kSecAttrProtocolIRCS;
        case ALSKeyChainStoreProtocolTypePOP3S:
...
- (CFTypeRef)authenticationTypeObject
{
    switch (_authenticationType) {
        case ALSKeyChainStoreAuthenticationTypeNTLM:
            return kSecAttrAuthenticationTypeNTLM;
        case ALSKeyChainStoreAuthenticationTypeMSN:
            return kSecAttrAuthenticationTypeMSN;
        case ALSKeyChainStoreAuthenticationTypeDPA:
            return kSecAttrAuthenticationTypeDPA;
        case ALSKeyChainStoreAuthenticationTypeRPA:
            return kSecAttrAuthenticationTypeRPA;
        case ALSKeyChainStoreAuthenticationTypeHTTPBasic:
            return kSecAttrAuthenticationTypeHTTPBasic;
        case ALSKeyChainStoreAuthenticationTypeHTTPDigest:
            return kSecAttrAuthenticationTypeHTTPDigest;
        case ALSKeyChainStoreAuthenticationTypeHTMLForm:
            return kSecAttrAuthenticationTypeHTMLForm;
        case ALSKeyChainStoreAuthenticationTypeDefault:
...
- (CFTypeRef)accessibilityObject
{
    switch (_accessibility) {
        case ALSKeyChainStoreAccessibilityWhenUnlocked:
            return kSecAttrAccessibleWhenUnlocked;
        case ALSKeyChainStoreAccessibilityAfterFirstUnlock:
            return kSecAttrAccessibleAfterFirstUnlock;
        case ALSKeyChainStoreAccessibilityAlways:
            return kSecAttrAccessibleAlways;
        case ALSKeyChainStoreAccessibilityWhenPasscodeSetThisDeviceOnly:
            return kSecAttrAccessibleWhenPasscodeSetThisDeviceOnly;
        case ALSKeyChainStoreAccessibilityWhenUnlockedThisDeviceOnly:
            return kSecAttrAccessibleWhenUnlockedThisDeviceOnly;
        case ALSKeyChainStoreAccessibilityAfterFirstUnlockThisDeviceOnly:
            return kSecAttrAccessibleAfterFirstUnlockThisDeviceOnly;
        case ALSKeyChainStoreAccessibilityAlwaysThisDeviceOnly:
...
{
    NSError *error = [NSError errorWithDomain:ALSKeyChainStoreErrorDomain code:ALSKeyChainStoreErrorInvalidArguments userInfo:@{NSLocalizedDescriptionKey: message}];
...
{
    NSError *error = [NSError errorWithDomain:ALSKeyChainStoreErrorDomain code:-67594 userInfo:@{NSLocalizedDescriptionKey: message}];
    NSLog(@"error: [%@] %@", @(error.code), error.localizedDescription);
    return error;
}
...
#endif
    NSError *error = [NSError errorWithDomain:ALSKeyChainStoreErrorDomain code:status userInfo:@{NSLocalizedDescriptionKey: message}];
...
{
    NSError *error = [NSError errorWithDomain:ALSKeyChainStoreErrorDomain code:-99999 userInfo:@{NSLocalizedDescriptionKey: message}];
    NSLog(@"error: [%@] %@", @(error.code), error.localizedDescription);
    return error;
}
...
@implementation ALSKeyChainStore (Deprecation)
