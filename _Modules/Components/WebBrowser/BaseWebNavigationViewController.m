...
#import "BaseWebNavigationViewController.h"
#import "BaseWebViewController.h"

@interface BaseWebNavigationViewController ()<UINavigationBarDelegate>
...
@implementation BaseWebNavigationViewController
...
- (BOOL)navigationBar:(UINavigationBar *)navigationBar shouldPopItem:(UINavigationItem *)item {
    ...
    if ([self.topViewController isKindOfClass:[BaseWebViewController class]]) {
        BaseWebViewController* webVC = (BaseWebViewController*)self.viewControllers.lastObject;
